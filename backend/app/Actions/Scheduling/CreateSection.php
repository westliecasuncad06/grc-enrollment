...
final class CreateSection
{
    ...
    /** @return array{academic_term_id: int, subject_id: int, section_code: string, professor_id: ?int, schedule_days: ?string, starts_at_time: ?string, ends_at_time: ?string, room: ?string, capacity: int, viability_threshold: ?int, enrolled_count: int, status: string} */
