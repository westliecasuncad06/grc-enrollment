...
<head>
    ...
    <title>Set up your GRC {{ $roleLabel }} account</title>
</head>
<body style="margin:0; padding:0; background-color:#f3f4f6; font-family:Arial, Helvetica, sans-serif;">
    <span style="display:none; visibility:hidden; opacity:0; color:transparent; height:0; width:0; overflow:hidden;">
        Your Global Reciprocal Colleges {{ $roleLabel }} account is ready. Use the one-time code inside to set your password.
    </span>
                    ...
                    <tr>
                        <td style="padding:40px 40px 8px 40px;">
                            ...
                            <p style="margin:0 0 16px 0; color:#374151; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.6;">
                                The Registrar's Office has invited you to a GRC {{ $roleLabel }} account. To finish setting it up, open the account setup page, enter your full name, and create your own private password using the one-time code below.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff7ed; border:1px solid #fde3cb; border-radius:6px;">
                                <tr>
                                    <td style="padding:14px 18px; color:#9a5b13; font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:1.6;">
                                        This code expires in {{ config('auth.passwords.users.expire') }} minutes and can be used only once. If you did not expect a GRC {{ $roleLabel }} account, you can safely ignore this email.
                                    </td>
                                </tr>
                            </table>
                        </td>
